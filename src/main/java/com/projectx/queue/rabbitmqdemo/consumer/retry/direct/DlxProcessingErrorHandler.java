package com.projectx.queue.rabbitmqdemo.consumer.retry.direct;

import java.io.IOException;
import java.time.LocalDateTime;

import com.projectx.queue.rabbitmqdemo.rabbitmq.RabbitmqHeader;
 ...
 * 
 * <p>
 * Generic class to handle RabbitMQ processing error that might occur on
...
public class DlxProcessingErrorHandler {
	 ...
	 *                         exchange name for really dead message (won't process
	 *                         anymore).
